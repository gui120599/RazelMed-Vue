                    ...
                    <form class="space-y-6" @submit="deleteUser">
                        <DialogHeader class="space-y-3">
                            ...
                            <DialogDescription>
                                ...
                                permanentemente. Insira sua senha para confirmar que deseja excluir sua conta permanentemente.
                            </DialogDescription>
                        </DialogHeader>
                        ...
                        <DialogFooter class="gap-2">
                            ...
                            <Button type="submit" variant="destructive" :disabled="form.processing"> Excluir conta
                            </Button>
                        </DialogFooter>
                    </form>
                </DialogContent>
