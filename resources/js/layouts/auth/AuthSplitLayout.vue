...
<template>
    <div class="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
        <div class="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
            <div class="absolute inset-0 text-gray-900 bg-gradient-to-b md:bg-gradient-to-r from-blue-500 " />
            <Link :href="route('home')" class="relative z-20 flex items-center text-lg font-medium text-gray-800">
                <AppLogoIcon class="mr-2 size-8 fill-current " />
                {{ name }}
            </Link>
            <AppLogoPng class="relative max-h-96 max-w-96 mx-auto my-auto" />
